package com.wpcompilers.compiler.model;
...
public class Scanner {
    ...
    public Scanner(String file) throws Exception{
    	...
    	this.file = new BufferedReader(inputString);
    	currentChar = (char)this.file.read();
    ...
    public ArrayList<Token> read() throws Exception{
